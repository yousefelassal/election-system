...
const Signup = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen gap-8 items-center w-full">
        ...
        <form onSubmit={form.handleSubmit(handleLogin)} className="flex w-full items-center max-w-md border rounded-xl bg-white flex-col gap-4 p-4 lg:py-12 lg:px-8">
            <h1 className="lg:hidden font-bold text-lg">Sign Up</h1>
            <h1 className="hidden lg:flex font-bold text-3xl">Create an account</h1>
