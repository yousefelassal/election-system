...
const Header = () => {
  ...
  return (
    <div className="flex items-center justify-between p-4 lg:px-8">
        ...
        <div className="flex p-1 bg-[#E0E0E0] rounded-xl flex-row gap-2 items-center justify-center min-w-[100px]">
            {tabs.map(tab => (
            <Link key={tab.href} to={tab.href} className={`flex rounded-lg flex-1 flex-col gap-1 text-sm relative items-center justify-center px-5 py-2 ${pathname === tab.href ? 'text-black' : 'text-gray-500 hover:text-gray-900'} cursor-pointer transition-colors`}>
